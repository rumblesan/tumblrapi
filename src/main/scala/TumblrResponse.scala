...
case class InfoQuery(blog:BlogInfo)
...
case class AnyQuery(blog:BlogInfo, posts:List[AnyPost], total_posts:Int)
...
case class PhotoQuery(blog:BlogInfo, posts:List[PhotoPost], total_posts:Int)
